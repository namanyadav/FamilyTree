...
class UserStoriesDgTest(unittest.TestCase):
    ...
    def test_us05(self):
        ...
        self.assertEqual(UserStoriesDg().get_id_list(UserStoriesDg().us05()), ['US0507F2', 'US0507F3', 'US0507F4', 'US0910F8'])
    ...
    def test_us07(self):
        ...
        self.assertEqual(UserStoriesDg().get_id_list(UserStoriesDg().us07()), ['US0507I1'])
