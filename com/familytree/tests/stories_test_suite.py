...
def suite():
    ...
    test_suite.addTest(UserStoriesRKTest('test_us24'))
    test_suite.addTest(UserStoriesRKTest('test_us32'))
    ...
    test_suite.addTest(UserStoriesMSKTest('test_us38'))
    test_suite.addTest(UserStoriesMSKTest('test_us39'))
