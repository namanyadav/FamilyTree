...
class UserStoriesNyTest(unittest.TestCase):
    ...
    def test_us01(self):
        ...
        self.assertEqual(['I1', 'I5', 'F1'], get_id_list(self.stories.us01()))

    def test_us08(self):
        """ I5, I6, I7, I8 have failing criteria in us08.ged """
        self.assertEqual(['I5', 'I6', 'I7', 'I8'], get_id_list(self.stories.us08()))

    def test_us13(self):
        self.assertEqual(['I1', 'I10', 'I5', 'I7'], get_id_list(self.stories.us13()))
